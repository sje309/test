...
public class App {
     ...
     */
    private final static ApplicationContext APPLICATION_CONTEXT =
            new ClassPathXmlApplicationContext("applicationContext.xml");

    /**
     * 获取AppConfig.java类中配置的注解
     */
    private final static ApplicationContext CONTEXT_ANNOTATION =
    ...
    public static void testAopExample() {
        //aop.CustomerService customerService = (aop.CustomerService) APPLICATION_CONTEXT.getBean("customerServcieAop");
        //
        //System.out.println("*******************************************************************");
        ...
        aop.CustomerService customerService = (aop.CustomerService) APPLICATION_CONTEXT.getBean("customerServiceProxy");
        System.out.println("*******************************************************************");
        customerService.printName();
    ...
    public static void testAutoWired() {
        autowired.Customer customer = (autowired.Customer) APPLICATION_CONTEXT.getBean("customerAutoWired");
    ...
    public static void testSpringElCollectionByXml() {
        ...
        spEL.ELCollectionsByXml collectionsByXml = (spEL.ELCollectionsByXml) APPLICATION_CONTEXT.getBean("elCollectionByXml");
    ...
    public static void testSpringELCollectionsByAnnotation() {
        ...
        spEL.ELCollections elCollections = (spEL.ELCollections) APPLICATION_CONTEXT.getBean("elCollections");
    ...
    public static void testSpringELOperators() {
        spEL.ElOperator elOperator = (spEL.ElOperator) APPLICATION_CONTEXT.getBean("eloperatorBean");
    ...
    public static void testSpringElByAnnotation() {
        spEL.ItemAnnotation itemAnnotation = (spEL.ItemAnnotation) APPLICATION_CONTEXT.getBean("itemBeanAnnotation");
        spEL.CustomerAnnotation customerAnnotation = (spEL.CustomerAnnotation) APPLICATION_CONTEXT.getBean("customerAnnotation");
        ...
        spEL.CustomerELCall customerELCall = (spEL.CustomerELCall) APPLICATION_CONTEXT.getBean("customerBeanElCall");
    ...
    public static void testSpringELByXml() {
        ...
        spEL.AddressByXml addressByXml = (spEL.AddressByXml) APPLICATION_CONTEXT.getBean("addressBeanXml");
        System.out.println(addressByXml.toString());

        spEL.CustomerByXml customerByXml = (spEL.CustomerByXml) APPLICATION_CONTEXT.getBean("customerBeanXml");
    ...
    public static void testFileNameGenerator() {
        FileNameGenerator fileNameGenerator = (FileNameGenerator) APPLICATION_CONTEXT.getBean("fileNameGenerator");
    ...
    public static void testSingletonBean() {
        CustomerService customerServiceA = (CustomerService) APPLICATION_CONTEXT.getBean("customerServiceSingleton");
        customerServiceA.setMessage("A Customer Service");
        System.out.println("customerServiceA.getMessage(): " + customerServiceA.getMessage());

        CustomerService customerServiceB = (CustomerService) APPLICATION_CONTEXT.getBean("customerService");

        System.out.println("customerServiceB.getMessage(): " + customerServiceB.getMessage());
        /**
         * 输出：
         * customerServiceA.getMessage(): A Customer Service
         * customerServiceB.getMessage(): A Customer Service
         */
    }

    public static void testPrototypeBean() {
        CustomerService customerServiceA = (CustomerService) APPLICATION_CONTEXT.getBean("customerServicePrototype");
        customerServiceA.setMessage("A Customer Service");
        System.out.println("customerServiceA.getMessage(): " + customerServiceA.getMessage());

        CustomerService customerServiceB = (CustomerService) APPLICATION_CONTEXT.getBean("customerServicePrototype");
        customerServiceB.setMessage("B Customer Service");
        System.out.println("CustomerServiceB.getMessage(): " + customerServiceB.getMessage());
        /** 输出：
         * customerServiceA.getMessage(): A Customer Service
         * CustomerServiceB.getMessage(): B Customer Service
         */
        /**
         * 输出:
         *  customerServiceA.getMessage(): A Customer Service
    ...
    public static void testCollectionBeans() {
        CustomerListBeans beans = (CustomerListBeans) APPLICATION_CONTEXT.getBean("customerListBeans");
    ...
    public static void testSpringListFactoryBean() {
        //普通ArrayList方式
        //CustomerListFactoryBean bean = (CustomerListFactoryBean) context.getBean("customerListFactory");
        //util模式
        CustomerListFactoryBean bean = (CustomerListFactoryBean) APPLICATION_CONTEXT.getBean("customerListFactoryBeanByUtil");
    ...
    public static void testSpringBeanRequired() {
        springCheck.Person person = (springCheck.Person) APPLICATION_CONTEXT.getBean("personBeanCheckBySimple");
        System.out.println(person.toString());
    }

    public static void testCustomerService() {
        //service.CustomerService customerService = (service.CustomerService) APPLICATION_CONTEXT.getBean("customerService");
        //System.out.println(customerService.getMessage());
        ////context.close()

        ConfigurableApplicationContext context = new ClassPathXmlApplicationContext("applicationContext.xml");
        service.CustomerService customerService = (service.CustomerService) context.getBean("customerService");
        System.out.println(customerService.getMessage());
        context.close();
    }
